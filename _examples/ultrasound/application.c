...
void application_init(void)
{
    ...
    // Echo channel B
    // Trig channel A
    bc_hc_sr04_init(&hc_sr04, BC_HC_SR04_ECHO_P5, BC_GPIO_P4);
    bc_hc_sr04_set_event_handler(&hc_sr04, hc_sr04_event_handler, NULL);
    bc_hc_sr04_set_update_interval(&hc_sr04, 100);
}
