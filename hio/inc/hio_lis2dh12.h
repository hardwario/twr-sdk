#ifndef _HIO_LIS2DH12_H
#define _HIO_LIS2DH12_H

#include <hio_i2c.h>
#include <hio_tick.h>
#include <hio_scheduler.h>

//! @addtogroup hio_lis2dh12 hio_lis2dh12
...
{
    //! @brief Error event
    HIO_LIS2DH12_EVENT_ERROR = 0,

    //! @brief Update event
    HIO_LIS2DH12_EVENT_UPDATE = 1,

    //! @brief Alarm event
    HIO_LIS2DH12_EVENT_ALARM = 2

} hio_lis2dh12_event_t;
...
typedef enum
{
    ...
    HIO_LIS2DH12_RESOLUTION_10BIT = 0,

    //! @brief 12-bit data output (High-resolution mode)
    HIO_LIS2DH12_RESOLUTION_12BIT = 1,

    //! @brief 8-bit data output (Low-power mode)
    HIO_LIS2DH12_RESOLUTION_8BIT = 2

} hio_lis2dh12_resolution_t;

typedef enum
{
    //! @brief ±2 g (Default)
    HIO_LIS2DH12_SCALE_2G = 0,

    //! @brief ±4 g
    HIO_LIS2DH12_SCALE_4G = 1,

    //! @brief ±8 g
    HIO_LIS2DH12_SCALE_8G = 2,

    //! @brief ±16 g
    HIO_LIS2DH12_SCALE_16G = 3,

} hio_lis2dh12_scale_t;
...
} hio_lis2dh12_alarm_t;

//! @brief LIS2DH12 instance

typedef struct hio_lis2dh12_t hio_lis2dh12_t;

//! @cond

typedef enum
{
    HIO_LIS2DH12_STATE_ERROR = -1,
    HIO_LIS2DH12_STATE_INITIALIZE = 0,
    HIO_LIS2DH12_STATE_MEASURE = 1,
    HIO_LIS2DH12_STATE_READ = 2,
    HIO_LIS2DH12_STATE_UPDATE = 3

} hio_lis2dh12_state_t;

struct hio_lis2dh12_t
{
    hio_i2c_channel_t _i2c_channel;
    uint8_t _i2c_address;
    void (*_event_handler)(hio_lis2dh12_t *, hio_lis2dh12_event_t, void *);
    void *_event_param;
    hio_tick_t _update_interval;
    hio_lis2dh12_state_t _state;
    bool _accelerometer_valid;
    hio_lis2dh12_result_raw_t _raw;
    bool _alarm_active;
    bool _irq_flag;
    hio_scheduler_task_id_t _task_id_interval;
    hio_scheduler_task_id_t _task_id_measure;
    bool _measurement_active;
    hio_lis2dh12_resolution_t _resolution;
    hio_lis2dh12_scale_t _scale;
};
