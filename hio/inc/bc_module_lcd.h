#ifndef _HIO_MODULE_LCD
#define _HIO_MODULE_LCD
...
//! @addtogroup hio_module_lcd hio_module_lcd
...
typedef enum
{
    HIO_MODULE_LCD_EVENT_LEFT_PRESS = 0x10 | HIO_BUTTON_EVENT_PRESS,
    HIO_MODULE_LCD_EVENT_LEFT_RELEASE = 0x10 | HIO_BUTTON_EVENT_RELEASE,
    HIO_MODULE_LCD_EVENT_LEFT_CLICK = 0x10 | HIO_BUTTON_EVENT_CLICK,
    HIO_MODULE_LCD_EVENT_LEFT_HOLD = 0x10 | HIO_BUTTON_EVENT_HOLD,

    HIO_MODULE_LCD_EVENT_RIGHT_PRESS = 0x20 | HIO_BUTTON_EVENT_PRESS,
    HIO_MODULE_LCD_EVENT_RIGHT_RELEASE = 0x20 | HIO_BUTTON_EVENT_RELEASE,
    HIO_MODULE_LCD_EVENT_RIGHT_CLICK = 0x20 | HIO_BUTTON_EVENT_CLICK,
    HIO_MODULE_LCD_EVENT_RIGHT_HOLD = 0x20 | HIO_BUTTON_EVENT_HOLD,

    HIO_MODULE_LCD_EVENT_BOTH_HOLD = 0x30 | HIO_BUTTON_EVENT_HOLD,

} hio_module_lcd_event_t;
...
typedef enum
{
    ...
    HIO_MODULE_LCD_ROTATION_0   = HIO_GFX_ROTATION_0,

    //! @brief LCD rotation 90 degrees
    HIO_MODULE_LCD_ROTATION_90  = HIO_GFX_ROTATION_90,

    //! @brief LCD rotation 180 degrees
    HIO_MODULE_LCD_ROTATION_180 = HIO_GFX_ROTATION_180,

    //! @brief LCD rotation 270 degrees
    HIO_MODULE_LCD_ROTATION_270 = HIO_GFX_ROTATION_270

} hio_module_lcd_rotation_t;
...
typedef enum
{
    ...
    HIO_MODULE_LCD_LED_RED = 0,

    //! @brief LCD green LED channel
    HIO_MODULE_LCD_LED_GREEN  = 1,

    //! @brief LCD blue LED channel
    HIO_MODULE_LCD_LED_BLUE = 2

} hio_module_lcd_led_t;
...
typedef enum
{
    ...
    HIO_MODULE_LCD_BUTTON_LEFT = 0,

    //! @brief LCD right button channel
    HIO_MODULE_LCD_BUTTON_RIGHT  = 1

} hio_module_lcd_button_t;
...
void hio_module_lcd_draw_pixel(int left, int top, bool color);
