...
typedef enum
{
    ...
    HIO_ADC_CHANNEL_A4 = 4,

    //! @brief ADC channel A5
    HIO_ADC_CHANNEL_A5 = 5,

    //! @brief ADC channel A6
    HIO_ADC_CHANNEL_A6 = 6
...
typedef enum
{
    ...
    HIO_ADC_OVERSAMPLING_NONE  = 0,

    //! @brief ADC 2x oversampling
    HIO_ADC_OVERSAMPLING_2 = 1,

    //! @brief ADC 4x oversampling
    HIO_ADC_OVERSAMPLING_4 = 2,

    //! @brief ADC 8x oversampling
    HIO_ADC_OVERSAMPLING_8 = 3,

    //! @brief ADC 16x oversampling
    HIO_ADC_OVERSAMPLING_16 = 4,

    //! @brief ADC 32x oversampling
    HIO_ADC_OVERSAMPLING_32 = 5,

    //! @brief ADC 64x oversampling
    HIO_ADC_OVERSAMPLING_64 = 6,

    //! @brief ADC 128x oversampling
    HIO_ADC_OVERSAMPLING_128 = 7,

    //! @brief ADC 256x oversampling
    HIO_ADC_OVERSAMPLING_256 = 8,

} hio_adc_oversampling_t;
...
typedef enum
{
    ...
    HIO_ADC_RESOLUTION_12_BIT  = 0,

    //! @brief ADC 10 bit resolution
    HIO_ADC_RESOLUTION_10_BIT = ADC_CFGR1_RES_0,

    //! @brief ADC 8 bit resolution
    HIO_ADC_RESOLUTION_8_BIT = ADC_CFGR1_RES_1,

    //! @brief ADC 6 bit resolution
    HIO_ADC_RESOLUTION_6_BIT = ADC_CFGR1_RES_1 | ADC_CFGR1_RES_0,

} hio_adc_resolution_t;
