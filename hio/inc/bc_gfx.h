...
typedef struct
{
    ...
    hio_gfx_caps_t (*get_caps)(void *self);
...
typedef enum
{
    ...
    HIO_GFX_ROTATION_0   = 0,

    //! @brief Rotation 90 degrees
    HIO_GFX_ROTATION_90  = 1,

    //! @brief Rotation 180 degrees
    HIO_GFX_ROTATION_180 = 2,

    //! @brief Rotation 270 degrees
    HIO_GFX_ROTATION_270 = 3
...
typedef enum
{
    ...
    HIO_GFX_ROUND_CORNER_RIGHT_TOP =    0x01,

    //! @brief Round corner right bottom
    HIO_GFX_ROUND_CORNER_RIGHT_BOTTOM = 0x02,

    //! @brief Round corner left bottom
    HIO_GFX_ROUND_CORNER_LEFT_BOTTOM = 0x04,

    //! @brief Round corner left top
    HIO_GFX_ROUND_CORNER_LEFT_TOP = 0x08

} hio_gfx_round_corner_t;
...
{
    void *_display;
    const hio_gfx_driver_t *_driver;
    hio_gfx_rotation_t _rotation;
    const hio_font_t *_font;
    hio_gfx_caps_t _caps;
