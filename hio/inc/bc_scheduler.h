#ifndef _HIO_SCHEDULER_H
#define _HIO_SCHEDULER_H

#include <hio_tick.h>

//! @addtogroup hio_scheduler hio_scheduler
//! @brief Task scheduler
//! @{

//! @brief Maximum number of tasks

#ifndef HIO_SCHEDULER_MAX_TASKS
#define HIO_SCHEDULER_MAX_TASKS 32
#endif

#ifndef HIO_SCHEDULER_INTERVAL_MS
#define HIO_SCHEDULER_INTERVAL_MS 10
#endif

//! @brief Task ID assigned by scheduler

typedef size_t hio_scheduler_task_id_t;
