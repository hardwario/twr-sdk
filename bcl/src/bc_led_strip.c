...
static uint32_t _bc_led_strip_dma_buffer_rgbw_144[sizeof(_bc_led_strip_framebuffer_rgbw_144) * 2];
...
static uint32_t _bc_led_strip_dma_buffer_rgb_150[sizeof(_bc_led_strip_framebuffer_rgb_150) * 2];
