...
{
    [BC_MODULE_SENSOR_CHANNEL_A_P4] = BC_GPIO_P4,
    [BC_MODULE_SENSOR_CHANNEL_B_P5] = BC_GPIO_P5
};

static const bc_tca9534a_pin_t _bc_module_sensor_channel_virtual_4k7_lut[2] =
{
    [BC_MODULE_SENSOR_CHANNEL_A_P4] = _BC_MODULE_SENSOR_CH_A_4K7,
    [BC_MODULE_SENSOR_CHANNEL_B_P5] = _BC_MODULE_SENSOR_CH_B_4K7
};

static const bc_tca9534a_pin_t _bc_module_sensor_channel_virtual_56r_lut[2] =
{
    [BC_MODULE_SENSOR_CHANNEL_A_P4] = _BC_MODULE_SENSOR_CH_A_56R,
    [BC_MODULE_SENSOR_CHANNEL_B_P5] = _BC_MODULE_SENSOR_CH_B_56R
};
...
bool bc_module_sensor_init(void)
{
    if (!_bc_module_sensor.initialized)
    {
        ...
        bc_gpio_init(_bc_module_sensor_channel_gpio_lut[BC_MODULE_SENSOR_CHANNEL_A_P4]);
        bc_gpio_init(_bc_module_sensor_channel_gpio_lut[BC_MODULE_SENSOR_CHANNEL_B_P5]);
