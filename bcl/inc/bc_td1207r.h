...
{
    //! @brief Error event
    BC_TD1207R_EVENT_ERROR = 0,

    //! @brief RF frame transmission started event
    BC_TD1207R_EVENT_SEND_RF_FRAME_START = 1,

    //! @brief RF frame transmission finished event
    BC_TD1207R_EVENT_SEND_RF_FRAME_DONE = 2
...
typedef enum
{
    ...
    BC_TD1207R_STATE_INITIALIZE = 0,
    BC_TD1207R_STATE_INITIALIZE_RESET_L = 1,
    BC_TD1207R_STATE_INITIALIZE_RESET_H = 2,
    BC_TD1207R_STATE_INITIALIZE_AT_COMMAND = 3,
    BC_TD1207R_STATE_INITIALIZE_AT_RESPONSE = 4,
    BC_TD1207R_STATE_IDLE = 5,
    BC_TD1207R_STATE_SEND_RF_FRAME_COMMAND = 6,
    BC_TD1207R_STATE_SEND_RF_FRAME_RESPONSE = 7
