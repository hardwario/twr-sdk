...
typedef enum
{
    TWR_CMWX1ZZABZ_STATE_READY = 0,
    TWR_CMWX1ZZABZ_STATE_ERROR = 1,
    TWR_CMWX1ZZABZ_STATE_INITIALIZE = 2,
    TWR_CMWX1ZZABZ_STATE_IDLE = 3,
    TWR_CMWX1ZZABZ_STATE_INITIALIZE_COMMAND_SEND = 5,
    TWR_CMWX1ZZABZ_STATE_INITIALIZE_COMMAND_RESPONSE = 6,

    TWR_CMWX1ZZABZ_STATE_CONFIG_SAVE_SEND = 7,
    TWR_CMWX1ZZABZ_STATE_CONFIG_SAVE_RESPONSE = 8,

    TWR_CMWX1ZZABZ_STATE_SEND_MESSAGE_COMMAND = 9,
    TWR_CMWX1ZZABZ_STATE_SEND_MESSAGE_CONFIRMED_COMMAND = 10,
    TWR_CMWX1ZZABZ_STATE_SEND_MESSAGE_RESPONSE = 11,
